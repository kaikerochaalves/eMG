...
lambda1 = 0.7 # Significance level
w = 10 # Window of size
sigma = 0.01 # Parameter to define the initial dispersion matrix
omega = 10**4 # Large real value [10^2, 10^4]
...
# Setting the hyperparameters
alpha = 0.01 # Basic learning rate
lambda1 = 0.01 # Significance level
w = 15 # Window of size
sigma = 0.1 # Parameter to define the initial dispersion matrix
omega = 10**4 # Large real value [10^2, 10^4]
...
plt.plot(OutputTestDenormalized1, color='blue', label='eMG')
plt.ylabel('Output')
plt.xlabel('Samples')
plt.legend()
plt.show()
...
plt.plot(OutputTestDenormalized2, color='blue', label='eMG')
plt.ylabel('Output')
plt.xlabel('Samples')
plt.legend()
plt.show()
