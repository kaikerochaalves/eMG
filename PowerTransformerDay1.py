...
alpha = 0.1 # Basic learning rate
lambda1 = 0.3 # Significance level
w = 10 # Window of size
sigma = 0.003 # Parameter to define the initial dispersion matrix
...
plt.plot(OutputTrainingDenormalized, color='blue', label='eMG')
plt.ylabel('Output')
plt.xlabel('Samples')
plt.legend()
plt.show()
